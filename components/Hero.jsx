      ...
      <div className="container mx-auto">
        ...
        <div className="flex items-center xl:h-[960px]">
          ...
          <div className="w-full xl:max-w-[460px] text-center xl:text-left">
            ...
            >
              by: <span className="text-orange">Wildin Wari</span>
            </motion.p>
            <motion.p
              variants={fadeIn("down", 0.2)}
              initial="hidden"
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.2 }}
            className="hidden xl:flex xl:absolute xl:top-[280px] xl:right-0"
          >
            <Image src="/hero/plate.png" width={756} height={682} alt="Manti" />
          </motion.div>
        </div>
      </div>
      {/* caffee Image */}
